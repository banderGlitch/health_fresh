...
def run_comparison():
    # Test cases: (symptom_text for SYNAPSE, symptom_category for finetuned triage, gender, age_bucket, duration, severity)
    test_cases = [
    ...
    # Map finetuned triage age/duration to SYNAPSE encoding
    # SYNAPSE Age: 0=16-45, 1=16-60, 2=6-15, 3=above 45, 4=above 60, 5=below 5
    age_to_synapse = {"16-30": 0, "31-50": 0, "50+": 4, "6-15": 2}
    # SYNAPSE Duration: 0=Greater than 3 days, 1=Less than 3 days
    ...
    print("-" * 80)
    print("\nKey difference: finetuned triage adds Emergency for severe acute cases (e.g. chest pain,")
    print("breathing shortness) — SYNAPSE maps those to Doctor Consultation only.")
