"""
Test the clarification flow: POST /analyze -> POST /analyze/continue.
Run API first: uvicorn api.main:app --reload
Then: python scripts/test_clarification_flow.py [--all]
  --all : run all test cases including tough ones (default: basic only)
"""
import argparse
import sys
