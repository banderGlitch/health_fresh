"""
Test finetuned triage model (models/finetuned_triage/).

- Input: 5 features (symptom category, gender, age bucket, duration, severity)
- Output: OTC Drug | Doctor Consultation | Emergency (3-way vs SYNAPSE 2-way)

Standalone test; run: python scripts/test_finetuned_triage.py
"""
import sys
